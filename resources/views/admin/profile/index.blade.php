        ...
        <div class="col-lg-4 col-md-5">
            <div class="card card-primary card-outline shadow-sm">
                <div class="card-body box-profile">
                    ...
                    <div class="mt-4">
                        <a href="#edit-tab" data-toggle="tab" class="btn btn-primary btn-block shadow-sm">
                            <i class="fas fa-edit mr-1"></i> Edit Profile
                        </a>
                        <a href="#password-tab" data-toggle="tab" class="btn btn-outline-secondary btn-block mt-2">
                    ...
                    <div class="mt-4 pt-3 border-top text-center">
                        ...
                        @else
                        <a href="#" class="badge badge-warning px-3 py-2">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            ...
                                            <input type="tel" name="phone" class="form-control @error('phone') is-invalid @enderror"
                                                value="{{ old('phone', $user->phone ? preg_replace('/^\+880/', '', $user->phone) : '') }}"
...
<script>
    $(function() {
        ...
        // Initialize all checkboxes with icheck-primary class
